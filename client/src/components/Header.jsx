  ...
  return (
    <div className="flex flex-col justify-center items-center text-center my-20">
      ...
      <h1 className="text-4xl max-w-[300px] sm:text-6xl sm:max-w-[590px] mx-auto mt-10 text-center">
        Turn text to <br /> <span className="text-[#F04A26]">image</span>, in
        seconds.
      </h1>

      <p className="text-center max-w-xl mx-auto mt-5">
        {" "}
        Go bananas with AI creativity. Toss your wildest ideas to our clever
        orangutan and watch them swing into stunning artwork in seconds.{" "}
      </p>
      ...
      <p className="mt-2 text-neutral-600">Generated Images from BananaBrush</p>
    </div>
  );
};
