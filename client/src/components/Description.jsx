...
const Description = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center justify-center my-28 px-6 md:px-20 lg:px-32"
    >
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 lg:gap-16">
        ...
        <div className="max-w-2xl">
          ...
          <p className="text-[#6B5B53] text-lg leading-relaxed mb-5">
            Toss in a crazy idea, a goofy thought, or even a dream you had at 3
            AM — our orangutan-powered AI will swing it into a beautiful image
            within seconds.
          </p>
